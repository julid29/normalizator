...
public class NombreRelacionWindow {
	...
	private void initialize() {
		...
		JLabel lblIngreseNombre = new JLabel("Ingrese el nombre de su relaci\u00F3n");
		...
		lblIngreseNombre.setFont(new Font("Arial", lblIngreseNombre.getFont().getStyle() | Font.BOLD, 22));
		...
		btnAtras.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				VentanaPrincipal ventanaPrincipalWin = VentanaPrincipal.getInstance();
		...
		btnSiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				setVisible(false);
				CargaAtributosWindow cargaWin = CargaAtributosWindow.getInstance();
